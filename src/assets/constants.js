...
export const listOfOrganizations = [
  ...
  },
  {
    ...
    tasks: [
      "✅️Developing a secured Internet Banking Application for cross-border transactions between India and Russia, by leveraging micro-frontend architecture in ReactJS to ensure modularity, scalability and compliance with strict banking regulations of RBI (Reserve Bank of India).",
      "✅️Leading the transformation of the application into a Progressive Web App (PWA) to ensure offline capability, native-like experience and responsiveness across device resolutions.",
